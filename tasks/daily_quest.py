...
PRAISE_NAVIGATION_STEPS = (
    ...
    NavigationStep("personal_might_check_to_leaderboard", "RANKINGS", "PERSONAL_MIGHT_CHECK", ("PERSONAL_MIGHT_LEADERBOARD",), source_anchor=PERSONAL_MIGHT_ROW, target_anchor=PERSONAL_MIGHT_CHECK),
