...
class GovernanceValidationTests(unittest.TestCase):
    ...
    def test_handoff_has_distinct_current_and_next_task_fields(self):
        ...
        self.assertEqual(state["current_task_id"], "VISION-SEMANTIC-OCR-CROP-PIPELINE")
        self.assertEqual(state["current_task_state"], "completed")
        self.assertEqual(state["next_task_id"], "VISION-NATIVE-FRAME-REPLAY-HARNESS")
        self.assertEqual(
    ...
    def test_declared_successor_exists_without_becoming_active(self):
        ...
        self.assertIn("VISION-NATIVE-FRAME-REPLAY-HARNESS", next_block)
