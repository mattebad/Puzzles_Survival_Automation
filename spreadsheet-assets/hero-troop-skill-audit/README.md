...
Beepboop No.7 has three Economy entries: Build Speed, Free Research Speedup, and Troop Size. No explicit `(Passive)` label appears on these panels, so `passive` is null in the manifest and blank in the CSV. Displayed units and numbers are transcribed as shown; no game meaning is inferred from the visual labels.
