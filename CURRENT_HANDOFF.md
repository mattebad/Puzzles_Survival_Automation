<!-- CURRENT_HANDOFF_STATE_BEGIN -->
{
  "schema_version": 2,
  "branch": "main",
  "head": "2d1dc50320c8c9cfae7b08be09b308e9e7e60bb7",
  "ahead_behind": {
    "ahead": 0,
    "behind": 0
  },
  ...
  "next_task_id": "CAMPAIGN-ATLAS-OFFLINE-FOUNDATION",
  ...
  "first_ready_flow": "CAMPAIGN-ATLAS-OFFLINE-FOUNDATION",
  "next_ready_flow": "CAMPAIGN-ATLAS-OFFLINE-FOUNDATION",
  ...
  "parent_conversation_loop": {
    ...
    "note": "Campaign Atlas authority reconciliation began from clean 2d1dc50. This handoff records the pre-commit head; the focused commit advances Git by one. Do not auto-start Foundation or runtime."
  },
  "latest_focused_validation_result": "Passed final 95-test flow-delivery orchestrator, Campaign separation, authority consistency, token/context hygiene, and governance run; deterministic backlog index generated 22 tasks with the Campaign Atlas dependency chain and Campaign AP mapping; git diff --check passed.",
  ...
  "last_safe_completed_step": "Created the serial Campaign Atlas authority chain and made its validated navigation integration a shared dependency of Campaign AP and Ultimate Challenge while preserving every zero-attempt gate.",
  "exact_next_permitted_action": "Start only the offline backlog task CAMPAIGN-ATLAS-OFFLINE-FOUNDATION in a new atomic turn; implement contracts, registration seam, dry-run survey planner, and independent tests with zero runtime input.",
  ...
  "recent_relevant_commits": [
    ...
    "257ec02 retain Noah's Tavern integrated implementation and semantic session"
  ],
  "process_deviations": [],
...
`CAMPAIGN-ATLAS-BACKLOG-DEPENDENCY-RECONCILIATION` established three serial atomic tasks: offline
Foundation, native survey/validation, and shared navigation integration/replay. Campaign AP and
...
Foundation is offline and ready. Survey and integration remain blocked, all attempt budgets remain
zero, and retained local Campaign frames remain mechanics/landmark candidates rather than promoted
atlas evidence. No runtime input, evidence fabrication, registration, or scheduler promotion occurred.

## Exact next action

Do not auto-start runtime or any downstream flow. The exact next permitted atomic task is
`CAMPAIGN-ATLAS-OFFLINE-FOUNDATION`: Campaign-specific contracts, reusable registration seam,
HUD masks, dry-run four-edge/overlapping-grid planner, provenance requirements, and independent
tests. It authorizes zero runtime input and must not manufacture atlas assets or evidence.
