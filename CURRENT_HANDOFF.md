<!-- CURRENT_HANDOFF_STATE_BEGIN -->
{
  ...
  "head_binding": "ed5ad567760666df60da75ba0895fd410402cdef",
  ...
  "current_live_attempt_state": "Phase 1 direct zero-input observation is parent-admitted on clean published candidate ed5ad567760666df60da75ba0895fd410402cdef; input and transport budgets are zero.",
  "current_evidence_or_session_reference": "R2 offline status/pulse/replay evidence plus r4 tests and Terra no-findings recheck; live observation evidence pending.",
  "last_safe_completed_step": "Published the accepted r4 repair and completed parent integration acceptance; no live attempt has occurred.",
  "exact_next_permitted_action": "Publish this integration checkpoint, recheck singleton/status, then run the exact direct development-session observe command with max-inputs 0.",
  "current_blocker": null,
  "prohibited_repeated_action": "Do not register or enable any flow, dispatch gameplay input or combat, confirm real-money, or run more than the single admitted zero-input observation.",
  "stage_revision": "runtime-reliability-stage-10-phase-1-observation-r4",
  "stage_type": "zero_input_observation_parent_accepted_pre_live",
  "product_precondition": "Proven: r4 repair tests and Terra recheck pass on published clean candidate.",
  "failure_class": "none",
  "budgets": {"stage_revisions_used": 4, "managed_turns_used": 8, "continuation_managed_turns_authorized": 5, "continuation_managed_turns_used": 5, "live_attempts_used": 0, "runtime_inputs_used": 0},
  ...
  "evidence": {"evidence_requirement": "One direct zero-input observation must report observed, input zero, ownership released, current native frame, and unchanged checkpoints", "monitoring_issue": "STAGE-10-PHASE-1-PRE-LIVE-ACCEPTED", "do_not_recursively_inspect_parent_evidence_tree": true},
