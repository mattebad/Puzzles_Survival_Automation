<!-- CURRENT_HANDOFF_STATE_BEGIN -->
{
  ...
  "current_task_id": "nano-material-product-authority-migration",
  "current_task_state": "completed_offline",
  "next_task_id": "nanoweapon-product-authority-migration",
  "next_task_activation_status": "awaiting_explicit_selection",
  "active_task_or_flow": "none",
  "active_delivery_stage": "nano_material_product_authority_accepted_offline",
  ...
  "latest_focused_validation_result": "Nano focused profile passed 26 tests with receipt 97b8df95db79d90b72b4b22dc99df136395da3e08bfa793dbac95ab8553e959a; authority/contract/Nanoweapon suites passed 67 tests; no runtime input.",
  "latest_architecture_validation_result": "Nano architecture profile passed 92 tests with receipt 8d39d9cfff31fb3cc950fc2853acf84a85a6e84082fae0688ddea085cd7bb1eb; no runtime input.",
  "latest_full_suite_result": "Manual opt-in only; not run.",
  "current_live_attempt_state": "not authorized and not attempted; Nano Material product authority and offline disposition used zero emulator/ADB/BlueStacks observation and zero runtime input",
  "current_evidence_or_session_reference": "No current native Material Production recognizer, controller, persistence, selector, idle/active/complete/timer/successor/Home proof is being claimed; typed authority and synthetic fixtures remain non-authorizing",
  "last_safe_completed_step": "Added nano_material_production-v1 typed authority binding canonical Home to one zero-resource six-hour Material Production batch with claim/start/defer successors and disabled registration; dispositioned route/session migration blocked offline.",
  "exact_next_permitted_action": "Perform Nanoweapon product authority migration only; preserve Nano Material blocked route/session disposition and do not dispatch any craft or maintenance input.",
  "current_blocker": "Native Material Production recognizer, controller, persistence, selector, idle/active/complete/timer/successor, and Home proof remains required before route/session admission; registration and scheduling stay disabled.",
  "prohibited_repeated_action": "Do not use emulator/ADB/BlueStacks, start Nano Material route/session migration, dispatch Material Production claim/start, dispatch Nanoweapon craft, begin Stage 8, or change registration/scheduler state.",
  "stage_revision": "nano-material-product-authority-migration-r1",
  "stage_type": "product_authority_migration",
  "product_precondition": "Nano Material typed authority binds the independent maintenance contract; native implementation and evidence remain absent.",
  "failure_class": "none offline",
  "budgets": {"stage_revisions_used": 3, "managed_turns_used": 7, "live_attempts_used": 0, "runtime_inputs_used": 0},
  ...
  "evidence": {"evidence_requirement": "Native Material Production recognizer, controller, persistence, selector, idle/active/complete/timer/successor, and Home proof remains required before route/session admission; current authority and synthetic fixtures are non-authorizing", "monitoring_issue": "MONITOR-UNOBSERVED-EFFECT-RECONCILIATION", "do_not_recursively_inspect_parent_evidence_tree": true},
  ...
  "next_three_atomic_tasks": [
    "Nano Material product authority: nano_material_production-v1 binds one zero-resource six-hour maintenance batch and is accepted offline; route/session migration is blocked and no input occurred.",
