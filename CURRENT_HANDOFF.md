<!-- CURRENT_HANDOFF_STATE_BEGIN -->
{
  ...
  "current_task_id": "hero-upgrade-product-authority-migration",
  "current_task_state": "completed_offline",
  "next_task_id": "hero-duel-product-authority-migration",
  "next_task_activation_status": "awaiting_explicit_selection",
  "active_task_or_flow": "none",
  "active_delivery_stage": "hero_upgrade_product_authority_accepted_offline",
  "active_execution_manifest_path": null,
  "development_lease_state": "absent",
  "runtime_ownership_state": "none",
  "writable_agent_state": "none",
  "unresolved_action_state": "clear",
  "latest_focused_validation_result": "Hero Upgrade focused profile passed 77 tests with receipt 080c0229fdaed4188fb3e7b25319924a73fe9fd483f4f4c66cbccf9c536eee65; no runtime input.",
  "latest_architecture_validation_result": "Hero Upgrade architecture profile passed 92 tests with receipt 07797b3648487655b9bf56e7523ef40d0e527a4e4a301326f15f4a21943a83e3; no runtime input.",
  "latest_full_suite_result": "Manual opt-in only; not run.",
  "current_live_attempt_state": "not authorized and not attempted; Hero Upgrade product authority and evidence-gated route contract used zero emulator/ADB/BlueStacks observation and zero runtime input",
  "current_evidence_or_session_reference": "No current native Hero surface, Wally identity, selected state, level/material/cost/balance, successor, progress, or canonical-Home route/session proof is claimed; offline candidate and synthetic upgrade fixtures remain non-authorizing",
  "last_safe_completed_step": "Added unresolved hero_upgrade-v1 candidate authority with Wally, level, material, amount, and balance uncertainty preserved fail-closed, bound an input-free evidence gate contract, preserved Upgrade dispatch disabled, and dispositioned native route/session migration blocked offline.",
  "exact_next_permitted_action": "Perform Hero Duel product authority migration only; preserve Hero Upgrade unresolved non-dispatching route/session disposition and do not dispatch any Upgrade input.",
  "current_blocker": "Exact current Wally identity, selected-hero level/material/cost/balance successor, reset/reorder state, and canonical-Home route/session proof remain required; registration and scheduling stay disabled.",
  "prohibited_repeated_action": "Do not use emulator/ADB/BlueStacks, dispatch any Upgrade or material spend, start Hero Upgrade route/session migration, register, schedule, or begin Stage 8.",
  "stage_revision": "hero-upgrade-product-authority-migration-r1",
  "stage_type": "product_authority_migration",
  "product_precondition": "Hero Upgrade candidate authority and input-free evidence-gate contract preserve unknown Wally, level, and material/cost bounds fail-closed; native route/session evidence remains absent.",
  ...
  "evidence": {"evidence_requirement": "Native Hero surface, Wally identity, selected state, exact level/material/amount/balance, one-level successor, completion progress, and canonical-Home route/session proof remain required before any route admission; current candidate and synthetic fixtures are non-authorizing", "monitoring_issue": "MONITOR-UNOBSERVED-EFFECT-RECONCILIATION", "do_not_recursively_inspect_parent_evidence_tree": true},
  ...
  "next_three_atomic_tasks": [
    "Box purchase product decision: explicitly blocked pending product authorization; no purchase occurred.",
