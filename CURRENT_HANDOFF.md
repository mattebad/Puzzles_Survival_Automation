<!-- CURRENT_HANDOFF_STATE_BEGIN -->
{
  ...
  "attributable_dirty_paths": ["tasks/product_authority.py", "tasks/flow_delivery_product_policy.json", "tasks/daily_quest_catalog.json", "tasks/gameplay_flow_contracts/BIOENHANCER-FREE-RESEARCH-BLUESTACKS-INTEGRATION.json", "tasks/gameplay_flow_contracts/CAMPAIGN-AP-AUTO-BATTLE-LIVE-CANARY.json", "tasks/gameplay_flow_contracts/DAILY-MILESTONE-CLAIM-BLUESTACKS-INTEGRATION.json", "tasks/gameplay_flow_contracts/DAILY-RESOURCE-ITEM-BLUESTACKS-INTEGRATION.json", "tasks/gameplay_flow_contracts/DAILY-ROW-CLAIM-BLUESTACKS-INTEGRATION.json", "tasks/gameplay_flow_contracts/ENHANCEMENT-FAMILY-BLUESTACKS-INTEGRATION.json", "tasks/gameplay_flow_contracts/NOVA-PRAISE-SUPERVISED-ONE-FREE-PULSE.json", "tasks/gameplay_flow_contracts/RECRUITMENT-BLUESTACKS-INTEGRATION.json", "tasks/gameplay_flow_contracts/RECRUITMENT-FREE-ATTEMPT-MAINTENANCE.json", "tasks/gameplay_flow_contracts/SUPPLY-DEPOT-BLUESTACKS-INTEGRATION.json", "tasks/gameplay_flow_contracts/TROOP-TRAINING-END-TO-END-CONSOLIDATION.json", "tasks/gameplay_flow_contracts/ULTIMATE-CHALLENGE-DAILY-BLUESTACKS-INTEGRATION.json", "tests/test_product_authority.py", "tests/test_gameplay_flow_contracts.py", "tests/test_catalog_and_pnsctl.py", "scripts/flow_delivery_campaign_bluestacks.py", "scripts/flow_delivery_troop_training_bluestacks.py", "scripts/pnsctl.py", "tasks/flow_delivery_validation_profiles.json", "tests/test_flow_delivery_campaign_bluestacks.py", "tests/test_flow_delivery_troop_training.py", "CURRENT_HANDOFF.md", "docs/runtime-reliability-convergence-status.md"],
  ...
  "current_task_id": "nanoweapon-product-authority-migration",
  "current_task_state": "completed_offline",
  "next_task_id": "ruins-shop-product-authority-migration",
  "next_task_activation_status": "awaiting_explicit_selection",
  "active_task_or_flow": "none",
  "active_delivery_stage": "nanoweapon_product_authority_accepted_offline",
  ...
  "latest_focused_validation_result": "Nanoweapon focused profile passed 10 tests with receipt 5c5518471576608109006d2578d6f6b0483a0354461bad2412418b50f3d7f4fe; authority/contract/Nanoweapon suites passed 74 tests; no runtime input.",
  "latest_architecture_validation_result": "Nanoweapon architecture profile passed 92 tests with receipt 5c8f5f4fe082611b01da519a0b39af9bf05b29567a3680a167520b6cdbd6d00a; no runtime input.",
  "latest_full_suite_result": "Manual opt-in only; not run.",
  "current_live_attempt_state": "not authorized and not attempted; Nanoweapon product authority and offline adapter/session repair used zero emulator/ADB/BlueStacks observation and zero runtime input",
  "current_evidence_or_session_reference": "No current native Gear Factory/radial/Nanoweapon/Normal Craft/claim/timer/successor/Home route proof is being claimed; typed authority and synthetic adapter fixtures remain non-authorizing",
  "last_safe_completed_step": "Added nanoweapon_normal_craft-v1 typed authority binding canonical Home to one exact 100-NANO_PARTS Normal Craft start per reset, reconciled pure adapter/session semantics to exact cost and 43200-second policy, and dispositioned native route/session migration blocked offline.",
  "exact_next_permitted_action": "Perform Ruins Shop product authority migration only; preserve Nanoweapon blocked route/session disposition and do not dispatch any craft or shop purchase input.",
  "current_blocker": "Native Gear Factory/radial/Nanoweapon/Normal Craft/claim/timer/successor/Home proof remains required before route/session admission; registration and scheduling stay disabled.",
  "prohibited_repeated_action": "Do not use emulator/ADB/BlueStacks, dispatch Nanoweapon craft, start Nanoweapon route/session migration, start any Shop purchase, begin Stage 8, or change registration/scheduler state.",
  "stage_revision": "nanoweapon-product-authority-migration-r1",
  "stage_type": "product_authority_migration",
  "product_precondition": "Nanoweapon typed authority binds the Daily contract and offline adapter/session semantics enforce exact Normal Craft policy; native route evidence remains absent.",
  ...
  "evidence": {"evidence_requirement": "Native Gear Factory/radial/Nanoweapon/Normal Craft/claim/timer/successor/Home proof remains required before route/session admission; current authority and synthetic adapter fixtures are non-authorizing", "monitoring_issue": "MONITOR-UNOBSERVED-EFFECT-RECONCILIATION", "do_not_recursively_inspect_parent_evidence_tree": true},
  ...
  "next_three_atomic_tasks": [
    "Nanoweapon product authority: nanoweapon_normal_craft-v1 binds exact Normal Craft policy and offline adapter/session repair is accepted; route/session migration is blocked and no craft occurred.",
