<!-- CURRENT_HANDOFF_STATE_BEGIN -->
{
  ...
  "current_task_id": "troop-training-product-authority-migration",
  "current_task_state": "completed_offline",
  "next_task_id": "troop-training-continuous-session-migration",
  "next_task_activation_status": "awaiting_explicit_selection",
  "active_task_or_flow": "none",
  "active_delivery_stage": "troop_training_product_authority_accepted_offline",
  ...
  "latest_focused_validation_result": "Troop Training product authority, revision-bound contract, catalog mapping, generated authority view, and affected contract tests passed 70 focused tests; no runtime input.",
  "latest_architecture_validation_result": "Troop Training architecture profile passed 92 tests with receipt 0bfe0cd9919c5e86a54aa3a276dcb6dd395af6d3d9fbf5a218a573b337ae7f78; no runtime input.",
  "latest_full_suite_result": "Manual opt-in only; not run.",
  "current_live_attempt_state": "not authorized and not attempted; Troop Training product authority migration used zero emulator/ADB/BlueStacks observation and zero runtime input",
  "current_evidence_or_session_reference": "No current Troop Training production-controller positive queue/timer/Home proof is being claimed; retained mechanics remain non-authorizing",
  "last_safe_completed_step": "Added r10 typed Troop Training authority for Fighter/Vehicle current-max continuous and Shooter/Rider fixed-250 once-daily variants, bound the existing consolidation contract, mapped four catalog rows without Daily ownership, and preserved disabled registration/scheduler state.",
  "exact_next_permitted_action": "Perform Troop Training continuous-session migration only; do not combine it with World work or any runtime action.",
  ...
  "prohibited_repeated_action": "Do not dispatch Troop Training, use emulator/ADB/BlueStacks, combine Troop Training session and World product migrations, begin Stage 8, registration/scheduler work, or select Gathering work before Troop Training session and World product tasks.",

  "stage_revision": "troop-training-product-authority-migration-r1",
  "stage_type": "medium_product_authority_migration",
  "product_precondition": "Troop Training resource/tier/quantity policy is explicitly approved; existing consolidation contract and controller are available.",
  ...
  "evidence": {"evidence_requirement": "Native Troop Training positive queue/timer/resource/Home proof remains required before live admission; current authority and synthetic fixtures are non-authorizing", "monitoring_issue": "MONITOR-UNOBSERVED-EFFECT-RECONCILIATION", "do_not_recursively_inspect_parent_evidence_tree": true},
