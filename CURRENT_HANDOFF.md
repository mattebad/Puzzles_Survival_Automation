<!-- CURRENT_HANDOFF_STATE_BEGIN -->
{
  ...
  "current_task_id": "hero-duel-product-authority-migration",
  "current_task_state": "completed_offline",
  "next_task_id": "vip-popup-helper-authority-migration",
  "next_task_activation_status": "awaiting_explicit_selection",
  "active_task_or_flow": "none",
  "active_delivery_stage": "hero_duel_product_authority_accepted_offline",
  "active_execution_manifest_path": null,
  "development_lease_state": "absent",
  "runtime_ownership_state": "none",
  "writable_agent_state": "none",
  "unresolved_action_state": "clear",
  "latest_focused_validation_result": "Hero Duel focused profile passed 79 tests with receipt 1b1126e4a6139f66826f21d21d4f3b2f891cad04ffe2ad3dfb6c0aaa381f9c28; no runtime input.",
  "latest_architecture_validation_result": "Hero Duel architecture profile passed 92 tests with receipt 99fc571c3f1b2d8c61a909b4eda2f9fb476a4b51d48ba9026c142d628cebce96; no runtime input.",
  "latest_full_suite_result": "Manual opt-in only; not run.",
  "current_live_attempt_state": "not authorized and not attempted; Hero Duel product authority and evidence-gated route contract used zero emulator/ADB/BlueStacks observation and zero runtime input",
  "current_evidence_or_session_reference": "No current native Hero Duel event, free opponent, Join state, attempts, participation result, loss/Exit safety, or canonical-Home route/session proof is claimed; offline candidate and synthetic PvP fixtures remain non-authorizing",
  "last_safe_completed_step": "Added prohibited hero_duel-v1 candidate authority with event, free-opponent, attempts, and participation uncertainty preserved fail-closed, bound an input-free evidence gate contract, preserved PvP entry disabled, and dispositioned native route/session migration blocked offline.",
  "exact_next_permitted_action": "Perform VIP popup helper authority migration only; preserve Hero Duel prohibited non-dispatching route/session disposition and do not dispatch any PvP input.",
  "current_blocker": "Exact current Hero Duel event, free opponent, Join state, attempts, participation successor, loss/Exit safety, and canonical-Home route/session proof remain required; registration and scheduling stay disabled.",
  "prohibited_repeated_action": "Do not use emulator/ADB/BlueStacks, dispatch PvP entry, lineup, combat, or loss input, start Hero Duel route/session migration, register, schedule, or begin Stage 8.",
  "stage_revision": "hero-duel-product-authority-migration-r1",
  "stage_type": "product_authority_migration",
  "product_precondition": "Hero Duel candidate authority and input-free evidence-gate contract preserve unknown event, free-opponent, attempts, and participation bounds fail-closed; native route/session evidence remains absent.",
  ...
  "evidence": {"evidence_requirement": "Native Hero Duel event, free opponent, Join state, attempts, participation result, loss/Exit safety, and canonical-Home route/session proof remain required before any route admission; current candidate and synthetic fixtures are non-authorizing", "monitoring_issue": "MONITOR-UNOBSERVED-EFFECT-RECONCILIATION", "do_not_recursively_inspect_parent_evidence_tree": true},
  ...
  "next_three_atomic_tasks": [
    "Hero Upgrade product authority: unknown Wally/level/material candidate is accepted offline; input-free evidence gate remains blocked and no Upgrade occurred.",
    "Hero Duel product authority: unknown event/opponent/attempt candidate is accepted offline; input-free evidence gate remains blocked and no PvP occurred.",
