<!-- CURRENT_HANDOFF_STATE_BEGIN -->
{
  ...
  "current_task_id": "ruins-shop-product-authority-migration",
  "current_task_state": "completed_offline",
  "next_task_id": "rare-earth-shop-product-authority-migration",
  "next_task_activation_status": "awaiting_explicit_selection",
  "active_task_or_flow": "none",
  "active_delivery_stage": "ruins_shop_product_authority_accepted_offline",
  "active_execution_manifest_path": null,
  "development_lease_state": "absent",
  "runtime_ownership_state": "none",
  "writable_agent_state": "none",
  "unresolved_action_state": "clear",
  "latest_focused_validation_result": "Ruins Shop focused profile passed 72 tests with receipt f049f90221113ad752b25ef9d22c70702f42ef2f9cff5842260a09d5d88791e6; no runtime input.",
  "latest_architecture_validation_result": "Ruins Shop architecture profile passed 92 tests with receipt 70c5f001e90e00f577609a995416d560c94366939a9e1b1a549bd7db6946c84b; no runtime input.",
  "latest_full_suite_result": "Manual opt-in only; not run.",
  "current_live_attempt_state": "not authorized and not attempted; Ruins Shop product authority and evidence-gated route contract used zero emulator/ADB/BlueStacks observation and zero runtime input",
  "current_evidence_or_session_reference": "No current native Ruins Shop offer, three-star Chip, 15 RUINS_COINS balance, quantity, item/currency delta, successor, or canonical-Home route/session proof is claimed; offline candidate and synthetic purchase fixtures remain non-authorizing",
  "last_safe_completed_step": "Added unresolved ruins_shop_purchase-v1 candidate authority with exact three-star Chip/15 RUINS_COINS/quantity-one bounds, bound an input-free evidence gate contract, preserved purchase dispatch disabled, and dispositioned native route/session migration blocked offline.",
  "exact_next_permitted_action": "Perform Rare Earth Shop product authority migration only; preserve Ruins Shop unresolved non-dispatching route/session disposition and do not dispatch any shop purchase input.",
  "current_blocker": "Explicit item/currency allowlist decision plus native Ruins Shop target, balance, quantity, successor, and canonical-Home route/session proof remain required; registration and scheduling stay disabled.",
  "prohibited_repeated_action": "Do not use emulator/ADB/BlueStacks, dispatch any shop purchase, start Ruins Shop route/session migration, register, schedule, or begin Stage 8.",
  "stage_revision": "ruins-shop-product-authority-migration-r1",
  "stage_type": "product_authority_migration",
  "product_precondition": "Ruins Shop candidate authority and input-free evidence-gate contract preserve exact unresolved purchase bounds; native route/session evidence remains absent.",
  "failure_class": "none offline",
  "budgets": {"stage_revisions_used": 2, "managed_turns_used": 9, "live_attempts_used": 0, "runtime_inputs_used": 0},
  ...
  "next_three_atomic_tasks": [
    "Ruins Shop product authority: unresolved three-star Chip/15 RUINS_COINS candidate is accepted offline; input-free evidence gate remains blocked and no purchase occurred.",
