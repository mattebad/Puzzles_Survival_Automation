<!-- CURRENT_HANDOFF_STATE_BEGIN -->
{
  ...
  "head_binding": "a2e38ae1939e5eca8b3fcddfa60485154d5cecb5",
  ...
  "active_delivery_stage": "stage_10_phase_1_r4_correction",
  "active_execution_manifest_path": "docs/execution-manifests/runtime-reliability-stage-10-phase-1-observation-r4.md",
  ...
  "current_live_attempt_state": "Phase 1 r4 explicitly authorized to correct the sole durable terminal-evidence defect; no live attempt has occurred.",
  "current_evidence_or_session_reference": "R2 offline evidence and r3 passing repair tests remain valid; r4 must make release/checkpoint failure artifacts fail-closed before recheck and zero-input observation.",
  "last_safe_completed_step": "User explicitly authorized the concrete r3 finding correction and continuation through phase 6; runtime ownership remained clear.",
  "exact_next_permitted_action": "Publish r4, run one Luna XHigh correction, exact tests, one Terra finding-only recheck, then parent-admit the direct zero-input observation.",
  "current_blocker": null,
  "prohibited_repeated_action": "Do not run the direct observation until r4 tests/recheck pass; do not register or enable any flow, dispatch gameplay input or combat, or confirm real-money.",
  "stage_revision": "runtime-reliability-stage-10-phase-1-observation-r4",
  "stage_type": "bounded_terminal_evidence_correction_then_observation",
  "product_precondition": "Proven: the only blocker is the concrete r3 durable terminal-evidence defect.",
  "failure_class": "local_defect",
  "budgets": {"stage_revisions_used": 4, "managed_turns_used": 8, "continuation_managed_turns_authorized": 5, "continuation_managed_turns_used": 3, "live_attempts_used": 0, "runtime_inputs_used": 0},
  ...
  "evidence": {"evidence_requirement": "R4 must persist truthful fail-closed terminal artifacts on release/checkpoint failure before recheck and zero-input observation", "monitoring_issue": "STAGE-10-PHASE-1-R4-CORRECTION", "do_not_recursively_inspect_parent_evidence_tree": true},
  "control_owner": "sol_parent",
  "control_parent_conversation_id": "current-task",
  "deferred_independent_review": "One Terra finding-only r4 recheck is authorized after the bounded correction; speculative or style findings are excluded.",
