<!-- CURRENT_HANDOFF_STATE_BEGIN -->
{
  "schema_version": 2,
  "branch": "main",
  "head": "dbf79dfa0ade87d3abc175e8d427ea81f625f36c",
  "ahead_behind": {
    "ahead": 6,
    "behind": 0
  },
  ...
  "parent_conversation_loop": {
    ...
    "note": "Campaign atlas navigation integration completed offline; queue transition closed; lease reconciled."
  },
  ...
  "last_safe_completed_step": "Focused commit 66acbd6, queue close dbf79df, counted completion, and lease reconciliation for CAMPAIGN-ATLAS-NAVIGATION-INTEGRATION-AND-REPLAY.",
  ...
  "journals_and_lease": {
    ...
    "development_lease_status": "absent; completed lease reconciled",
...
registration, or scheduler eligibility changed. Focused commit: `66acbd6`. Close commit: `dbf79df`.
