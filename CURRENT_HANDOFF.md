<!-- CURRENT_HANDOFF_STATE_BEGIN -->
{
  ...
  "current_task_id": "campaign-ap-product-authority-migration",
  "current_task_state": "completed_offline",
  "next_task_id": "campaign-ap-continuous-session-migration",
  "next_task_activation_status": "awaiting_explicit_selection",
  "active_task_or_flow": "none",
  "active_delivery_stage": "campaign_ap_product_authority_migration",
  ...
  "latest_focused_validation_result": "Campaign authority, contract, catalog, and product-policy tests passed 67 tests; Campaign AP product binding and catalog ownership validated; no runtime input.",
  "latest_architecture_validation_result": "Campaign architecture profile passed 92 tests with receipt a850bb854e5fe33c1a1226b6bae546d236e345ca62100b13b423ae8691d509f9; no runtime input.",
  "latest_full_suite_result": "Manual opt-in only; not run.",
  "current_live_attempt_state": "not authorized and not attempted; Campaign product authority work uses zero emulator/ADB/BlueStacks observation and zero runtime input",
  "current_evidence_or_session_reference": "No current Campaign AP production-controller proof is being claimed; retained mechanics remain non-authorizing",
  "last_safe_completed_step": "Bound Campaign AP product authority record and revision-bound direct contract offline; session behavior remains a separate next task.",
  "exact_next_permitted_action": "Perform Campaign AP continuous-session migration only; do not combine Troop Training or any live Campaign AP action.",
  "current_blocker": "Native production-controller evidence remains required before any Campaign AP live canary; registration and scheduling stay disabled.",
  "prohibited_repeated_action": "Do not dispatch Campaign AP, use emulator/ADB/BlueStacks, combine product and session migrations, begin Stage 8, registration/scheduler work, or select Troop Training before Campaign AP session migration.",

  "stage_revision": "campaign-ap-product-authority-migration-r1",
  "stage_type": "medium_product_authority_migration",
  "product_precondition": "Campaign AP policy rules and existing offline mechanics are available; product authority was missing.",
  ...
  "evidence": {"evidence_requirement": "Native production-controller Campaign AP positive stage/cost/result/AP-delta/Home proof remains required before live admission; current proof is evidence_required", "monitoring_issue": "MONITOR-UNOBSERVED-EFFECT-RECONCILIATION", "do_not_recursively_inspect_parent_evidence_tree": true},
  ...
  "next_three_atomic_tasks": [
    "Campaign AP continuous-session migration: bind unchanged controller and exact AP/result/Home semantics to one session only; retain evidence_required and disabled registration.",
