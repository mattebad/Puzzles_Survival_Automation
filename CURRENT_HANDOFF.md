<!-- CURRENT_HANDOFF_STATE_BEGIN -->
{
  ...
  "head_binding": "b42c9aa",
  "last_product_candidate_head": "b42c9aa",
  ...
  "current_task_id": "stage-10-phase-6-troop-training-r1",
  "current_task_state": "blocked_evidence_required",
  "next_task_id": "stage-11-final-reconciliation",
  "next_task_activation_status": "authorized_pending_freeze",
  "active_task_or_flow": "none",
  "active_delivery_stage": "stage_10_phase_6_blocked_disposition",
  "active_execution_manifest_path": "docs/execution-manifests/runtime-reliability-stage-10-phase-6-troop-training-r1.md",
  "development_lease_state": "absent",
  "runtime_ownership_state": "none",
  "writable_agent_state": "none",
  "unresolved_action_state": "clear",
  "latest_focused_validation_result": "Phase 6 precondition audit found 37 retained dispatch-bearing Troop Training artifacts against a hard maximum of one; 17 entry tests and 33 gameplay-contract tests passed, while broader flow/controller invocations emitted no failure but did not terminate inside the foreground window.",
  "latest_architecture_validation_result": "The existing maximum-live-canary fence was preserved; no registration, scheduler selection, runtime ownership, or input was admitted.",
  "latest_full_suite_result": "Manual opt-in only; not run.",
  "current_live_attempt_state": "No Phase 6 live attempt was allowed because the checked-in route's dispatch-bearing canary budget was already exhausted by retained historical evidence.",
  "current_evidence_or_session_reference": ".local-captures/flow-delivery/TROOP-TRAINING-END-TO-END-CONSOLIDATION (37 dispatch-bearing retained artifacts audited read-only)",
  "last_safe_completed_step": "Truthfully dispositioned Phase 6 blocked_evidence_required without registration or runtime after the immutable prior-canary audit exceeded the hard one-canary ceiling.",
  "exact_next_permitted_action": "Freeze Stage 11 final reconciliation, reconcile every Phase 1-6 disposition, retire or quarantine superseded executable paths, validate convergence, and prepare the authorized merge boundary.",
  "current_blocker": "Phase 6 cannot admit a new Troop Training canary because 37 retained dispatch-bearing artifacts already exceed MAX_DISPATCH_BEARING_CANARY_RUNS=1; historical evidence cannot be deleted or relabeled to manufacture eligibility.",
  "prohibited_repeated_action": "Do not run a new Troop Training canary, repeat Phase 4 or Phase 5, automate PvP/player attacks, or confirm real-money.",
  "stage_revision": "runtime-reliability-stage-10-phase-6-troop-training-r1",
  "stage_type": "queue_generation_maintenance_phase_blocked",
  "product_precondition": "Troop Training product authority and verifier are accepted, but the immutable maximum-live-canary precondition is exhausted before scheduler promotion.",
  "failure_class": "prior_canary_budget_exhausted",
  "budgets": {"phase_6_live_attempts_used": 0, "phase_6_runtime_inputs_used": 0, "phase_6_train_actions_used": 0, "phase_6_identical_retries_used": 0, "prior_dispatch_bearing_artifacts_observed": 37, "maximum_dispatch_bearing_canary_runs": 1},
  ...
  "evidence": {"evidence_requirement": "blocked_evidence_required for Phase 6", "monitoring_issue": "STAGE-10-PHASE-6-TROOP-TRAINING-PRIOR-CANARY-BUDGET", "do_not_recursively_inspect_parent_evidence_tree": true},
  "control_owner": "sol_parent",
  "control_parent_conversation_id": "current-task",
  "deferred_independent_review": "Phase 6 required no implementation or live admission; final Stage 11 and PR review remain pending.",
