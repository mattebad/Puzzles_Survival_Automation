...
Repository authority: catalog owns `boost_resource_building_output`; matrix owns disabled policy/status; `docs/archive/backlog-legacy.md` preserves the historical task record. Main Quest Claim excluded.
