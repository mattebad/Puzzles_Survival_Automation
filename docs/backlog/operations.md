...
- Evidence: `docs/archive/backlog-legacy.md` audited at ranges `1-598`, `1099-1641`, `4299-5494`, `5640-6712`, and `7414-7717`; `governance-simplification-plan.md` phases 0–7 and gates 1–38; `docs/archive/runtime-reliability-convergence-status.md`; `docs/pns-operations-runbook.md`.
...
- Evidence: plan §§5.2–5.3, 7, 15, 18–20; `automation_service/service.py`; `automation_service/scheduler.py`; `automation_service/state.py`; `docs/archive/runtime-reliability-convergence-status.md`; `compose.automation-service.yml`.
...
- Evidence: plan §§2, 5.2–5.3, 15, 18–20; `docs/archive/runtime-reliability-convergence-status.md`; `docs/automation-service.md`; `compose.automation-service.yml`; `automation_service/service.py`; `automation_service/state.py`.
